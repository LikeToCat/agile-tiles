...
from src.module.QQGrop.qq_grop_form import Ui_Form
from src.util import browser_util


class QQGropWindow(AgileTilesAcrylicWindow, Ui_Form):

    use_parent = None

    def __init__(self, parent=None, use_parent=None):
        super(QQGropWindow, self).__init__(is_dark=use_parent.is_dark, form_theme_mode=use_parent.form_theme_mode,
        ...
        # 设置标题栏
        self.setWindowTitle("灵卡面板 - QQ交流群")
    ...
    def _init_ui(self):
        ...
        # 设置图标
        self.label_icon.setPixmap(QPixmap(":static/img/icon/qq_qr_code.png"))
        self.label_icon.setFixedSize(200, 200)
        self.label_icon.setScaledContents(True)

    def push_button_link_click(self):
        # 用户协议
        browser_util.open_url(common.qq_grop)
        self.close()
